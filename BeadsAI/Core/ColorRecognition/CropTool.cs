...
namespace BeadsAI.Core.ColorRecognition
{
    public class CropTool
    {
        ...
        public static Image<Rgba32>[] SplitHorizontalImage(Image<Rgba32> source,int parts) // vertical becomes shorter
        {
        ...
        public static Image<Rgba32>[] SplitVerticalImage(Image<Rgba32> source,int parts) // horizantal becomes shorter
        {
